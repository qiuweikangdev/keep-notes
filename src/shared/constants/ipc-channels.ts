export const IPC_CHANNELS = {
  ...
  QUICK_EDITOR: {
    SAVE_STATE: "quick-editor:save-state",
    ...
    COLLAPSED_CHANGED: "quick-editor:collapsed-changed",
  },
  FILE: {
    READ: "file:read",
    WRITE: "file:write",
    LOAD_IMAGE_AS_DATA_URL: "file:load-image-as-data-url",
    SAVE_IMAGE_ATTACHMENT: "file:save-image-attachment",
    SAVE_AS: "file:save-as",
    CONFIRM_CLOSE_UNTITLED: "file:confirm-close-untitled",
  ...
  REMINDER: {
    ...
    RESIZE_WINDOW: "reminder:resize-window",
    WINDOW_SHOWN: "reminder:window-shown",
    PREWARM_EDITOR_WINDOW: "reminder:prewarm-editor-window",
    SHOW_EDITOR_WINDOW: "reminder:show-editor-window",
    EDITOR_REQUESTED: "reminder:editor-requested",
    EDITOR_RENDERER_READY: "reminder:editor-renderer-ready",
    EDITOR_REQUEST_APPLIED: "reminder:editor-request-applied",
    RESIZE_EDITOR_WINDOW: "reminder:resize-editor-window",
    CLOSE_EDITOR_WINDOW: "reminder:close-editor-window",
  },
  NOTIFICATION: {
